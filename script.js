...
const I18N = {
  'zh-CN': {
    ...
    /* AI-AVATAR */
    aiTitle: 'AI分身 · AI番茄闹钟助手',
    aiGreeting: '你好！我是 AI番茄闹钟 的 AI分身 🍅 关于 AI 任务排序、番茄专注时长、进度统计或价格，都可以问我。',
  ...
  'en': {
    ...
    /* AI-AVATAR */
    aiTitle: 'AI Avatar · AI Pomodoro Assistant',
    aiGreeting: 'Hi! I\'m the AI avatar for AI Pomodoro Timer 🍅 Ask me about AI task sorting, focus session lengths, progress stats, or pricing.',
    aiPlaceholder: 'Type your question…',
    aiSend: 'Send',
    aiChip1: 'How does AI sort my tasks?',
    aiChip2: 'Can I customize session length?',
    aiChip3: 'Does it work on iPad?',
...
(function () {
  ...
  const AI_SYSTEM_PROMPT = [
    'You are the "AI分身" (AI avatar) assistant on the promo website of AI Pomodoro Timer (AI番茄闹钟), an iOS focus/productivity app by WeiProduct.',
    '',
    'App facts (the ONLY facts you may state):',
    '- One-liner: let AI plan your next focus session — AI task priority sorting, smart time allocation, and the Pomodoro focus rhythm in one lightweight app.',
    '- Key features: AI task sorting by urgency and importance (you can always reorder manually); adaptive time blocks — focus and break lengths adjust per task, 25 minutes is a starting point not a fixed template; a clean minimal Pomodoro focus timer; adaptive break/work reminders that avoid fatigue build-up; progress tracking with history, trends, and focus streaks.',
    '- Design stance: clean and distraction-free — no ads, no gimmicky pop-ups; built for focus.',
    '- Platform: universal app for iPhone and iPad (iOS / iPadOS).',
    '- Price: free.',
    '- Languages: English and Simplified Chinese (中文).',
    '- App Store link: https://apps.apple.com/app/id6748548518',
    '',
    'Style rules:',
    ...
    '- NEVER invent download counts, ratings, reviews, iOS version requirements, or features not listed above.',
    '- If asked about unrelated topics, politely steer the conversation back to AI Pomodoro Timer.',
